package com.example.ddd.application.doc.service;

import com.example.ddd.domain.agent.repository.DocRepository;
...
public class DocService {
    ...
    public List<DocView> listByUserId(String userId) {
        return docRepository.queryByUserId(userId);
    }
    ...
    public DocView addDocument(DocAddRequest request) {
        ...
        DocPO result = docRepository.insert(docPO);
